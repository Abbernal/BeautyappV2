...
public class EmployeeConfirmedAppointmentsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appBar != null) {
            setupAppBar(getString(R.string.confirmed_appointments));
        }
    ...
    private void loadAppointments() {
        ...
        adapter = new EmployeeAppointmentsAdapter(citas, this, db, "confirmed");
        recyclerView.setAdapter(adapter);
        
        if (tvEmptyState != null) {
            if (citas == null || citas.isEmpty()) {
                tvEmptyState.setVisibility(View.VISIBLE);
                tvEmptyState.setText(getString(R.string.no_confirmed_appointments));
